...
# Load dataset
df = pd.read_csv('car_new_data.csv')
...
def main():
    ...
    if st.button('Predict Price'):
        ...
        # Add color to the success message
         #success_message = "Your success message here"
         colored_message = f'<span style="color: darkblue; font-size: 30px; font-weight: bold;">{success_message}</span>'

         #colored_message =  f'<span style="color: lhtigblue; font-size: 24px;font-weight: bold;">{success_message}</span>'
